    ...
    <ContainerFormAntd layout={"vertical"}>
      <div style={{ marginTop: "15px", width: "100%" }}>
        ...
        >
          ...
          <Tooltip title="Con esta información se puede identificar a cada proveedor, se asigna un código único, la fecha en que inicio a ser proveedor de GESTNETT y un nombre (apodo, nombre comercial, etc).">
        ...
        >
          ...
          >
            ...
            <Form.Item
              style={{ width: "35%" }}
              name={"fechaInicioProveedor"}
              label={<strong>Fecha de inicio como proveedor:</strong>}
            >
