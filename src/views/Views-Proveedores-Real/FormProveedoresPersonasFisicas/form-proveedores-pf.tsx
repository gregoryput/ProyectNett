...
const FormProveedoresPersonsFi = (props: IFormClientesProps) => {
        ...
        >
          <div style={{ marginTop: "15px", width: "100%" }}>
            ...
            >
              ...
              <Form.Item
                name={"Codigo"}
                label={<strong>Código del proveedor:</strong>}
                style={{ width: "29%" }}
              >
                <Input />
              </Form.Item>
              ...
              >
                ...
                >
                  <Select
                    ...
                    placeholder="Buscar datos personales"
                  />
                  <div
                    style={{
                      display: "flex",
...
export default FormProveedoresPersonsFi;
