...
import { BiBox, BiBriefcaseAlt,BiHomeAlt2,BiWallet,BiWalletAlt,BiBulb,BiUser,BiPieChartAlt,BiPackage } from "react-icons/bi";
  ...
  return (
   <>
    <DivContainerNav>
      ...
      <ButtonNav exact  to="/"   style={({ isActive }) => {return { color: isActive ? "#365583" : ""}}}>
